...
class PoseKalmanFilter(
    ...
    private val processNoiseX: Double = 1.0,
    private val processNoiseY: Double = 1.0,
    private val processNoiseTheta: Double = 0.005,
    // Measurement noise - uncertainty in AprilTag measurements (in mm and radians)
    private val measurementNoiseX: Double = 10.0,
    private val measurementNoiseY: Double = 10.0,
    private val measurementNoiseTheta: Double = 0.02
) {
     ...
     */
    fun isOutlier(measurement: Pose, threshold: Double = 3.0): Boolean {
        val diff = Pose(
